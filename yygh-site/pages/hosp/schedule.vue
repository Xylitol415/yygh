              ...
              <div class="list-item">
                ...
                <div class="right-wrapper">
                  ...
                  <div class="button-wrapper">
                    <div class="v-button" @click="booking(item.id, item.hosScheduleId, item.availableNumber)" :style="item.availableNumber == 0 || pageFirstStatus == -1 ? 'background-color: #7f828b;' : ''">
...
export default {
  ...
  methods: {
    ...
    booking (scheduleId, hosScheduleId, availableNumber) {
      debugger
