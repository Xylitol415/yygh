<template>
  <div class="header-container">
    <div class="wrapper">
      <!-- logo -->
      <div class="left-wrapper v-link selected" onclick="window.location.href= 'http://localhost:3000';return false">
    ...
    <!-- 登录弹出层 -->
    <!-- 加上v-if标签，每次重新渲染页面，不会出现页面一刷新就会有登录弹框el-dialog 一闪而过 的现象 -->
    <el-dialog :visible.sync="dialogUserFormVisible" style="text-align: left;" top="50px" :append-to-body="true" width="960px" @close="closeDialog()" v-if="dialogUserFormVisible">
      <div class="container">
  ...
  methods: {
    ...
    loginCallback (name, token, openid) {
      ...
      if (openid != '' && openid != null) {
        // alert("open id" + openid)
        // console.log(openid)
        this.userInfo.openid = openid
        this.showLogin()
      } else {
        // alert("有手机号，不用手机验证码绑定了。。。")
