...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, OrderInfo>
    ...
    // 生成挂号订单
    @Override
    public Long saveOrder(String scheduleId, String hosScheduleId, Long patientId) {
        // 获取就诊人信息
        ...
        orderInfo.setScheduleId(hosScheduleId); // 改传排班表中id！！！
        ...
        // 请求医院系统接口 hospital-manage模块中HospitalController类中AgreeAccountLendProject方法的请求路径 /order/submitOrder
