...
public class ScheduleServiceImpl  extends
    ...
    public Map<String, Object> getRuleSchedule(long page, long limit, String hoscode, String depcode) {
        // 1.根据医院编号 和 科室编号 查询
        Criteria criteria = Criteria.where("hoscode").is(hoscode).where("depcode").is(depcode);
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
        ...
        // 把得到的list集合遍历，向其中设置其他值：医院名称、科室名称、日期对应星期
    ...
    // 根据排班id获取排班数据
    @Override
    public Schedule getScheduleIdById(String scheduleId) {
